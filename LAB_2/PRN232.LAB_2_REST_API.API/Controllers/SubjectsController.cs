...
{
    /// <summary>
    /// Subjects API v1/v2 - Quản lý môn học.
    ...
    public class SubjectsController : ControllerBase
    {
            ...
            [FromHeader(Name = "X-Request-Id")] string? requestId = null)
        {
            ...
            {
                Success = true,
                Message = "Retrieved subject information successfully!",
                Data = responseModel
            });
        }
            ...
            [FromHeader(Name = "X-Request-Id")] string? requestId = null)
        {
            ...
            return Ok(new ApiResponse<object>
            {
                ...
                Success = true,
                Message = "Retrieved list of subjects successfully!",
                Data = shapedData
            });
        }
        ...
        [HttpPut("{id:int}")]
        [Authorize(Roles = "Admin")]
        public async Task<IActionResult> UpdateSubject([FromRoute] int id, [FromBody] SubjectRequest request)
        {
            ...
            if (!ModelState.IsValid)
            {
                ...
                {
                    Success = false,
                    Message = "Data to update.môn học không hợp lệ!",
                    Errors = ModelState
                });
            }
        ...
        public async Task<IActionResult> DeleteSubject([FromRoute] int id)
        {
            ...
            if (!isDeleted)
            {
                ...
                {
                    Success = false,
                    Message = "Subject does not exist or cannot be deleted!",
                    Errors = "404 Not Found"
                });
            }
